...
from config.loader import load_config, save_gateway, save_devices, get_devices, get_gateway, get_signals
...
class MqttGateway:
    ...
    def send_signals_temp(self, organization_id: str, gateway_id: str, device: dict, value: int):
